...
export const PatientDashboard: React.FC = () => {
  ...
  const handleUploadSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if(currentUser) {
        uploadRecord(currentUser.id, uploadForm.title, uploadForm.description, uploadForm.fileType, uploadForm.fileName || 'document.pdf');
        setShowUploadModal(false);
        setUploadForm({ title: '', description: '', fileType: 'PDF', fileName: '' }); // Reset
